...
const Features1 = ({ features, containerClass }: FeaturesProps) => {
    return (
        <section id="features" className={containerClass}>
            <Container>
                <Row className="justify-content-center">
                    <Col className="text-center">
                        ...
                        <h1 className="display-5 fw-medium">Subtitular nunca fue tan fácil</h1>
                        <p className="text-muted mx-auto">
                            Empieza a trabajar con <span className="text-primary fw-bold">SubtitlePro</span> y olvídate
                            de las transcripciones manuales
                        </p>
                    </Col>
                </Row>
