                ...
                <Row className="align-items-center">
                    <Col lg={5}>
                        <div className="mb-5 mb-lg-0" data-aos="fade-up" data-aos-duration="200">
                            ...
                            <h1 className="text-dark">Precisión con IA en cada palabra</h1>
                            <p className="text-muted my-4">
                                Nuestra inteligencia artificial reconoce el habla con una precisión sorprendente,
                                incluso con ruido de fondo y acentos variados. Edita cualquier línea y corrige el
                                tiempo de los subtítulos con un clic.
                            </p>
